...
## Table 1: Method Comparison — Best Config Under Bandwidth Constraint
...
> **核心结论**: β-VAE β=0.01 achieves **6.4 bit effective rate** — **90× compression** vs raw 576 bits.
...
> VQ-VAE 的 'β' 维度。LD=8 下码本利用率始终 ≤14%，远不及 LD=2 的 100%——低维空间更易填满离散码本。
...
> **后验坍塌率**: β≥0.5 时 100% 的配置KL<0.05——编码器完全退化为先验N(0,I)。